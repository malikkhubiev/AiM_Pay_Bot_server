        ...
        if payment:
            ...
            if referrer:
                ...
                if referrer_user:
                    ...
                    new_balance = int(referrer_user.balance + float(REFERRAL_AMOUNT))
                    logging.info(f"referrer_user.balance {referrer_user.balance}")
                    logging.info(f"float(REFERRAL_AMOUNT) {float(REFERRAL_AMOUNT)}")
